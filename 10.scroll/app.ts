...
// ********** close links ************
const navToggle: HTMLButtonElement = document.querySelector(".nav-toggle");
const linksContainer: HTMLDivElement = document.querySelector(".links-container");
const links: HTMLUListElement = document.querySelector(".links");
...
const topLink: HTMLAnchorElement = document.querySelector(".top-link");
...
scrollLinks.forEach((link) => {
  link.addEventListener("click", (event: MouseEvent) => {
    ...
    const id = (event.currentTarget as HTMLAnchorElement).getAttribute("href").slice(1);
