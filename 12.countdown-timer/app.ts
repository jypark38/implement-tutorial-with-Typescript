...
const giveaway: HTMLHeadingElement = document.querySelector(".giveaway");
const deadline: HTMLDivElement = document.querySelector(".deadline");
const items: NodeListOf<HTMLHeadingElement> = document.querySelectorAll(".deadline-format h4");
...
function getRemainingTime(): void {
